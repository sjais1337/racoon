...
def preprocess_adult_data(df_path):
    try:
    ...
    target_column_name = 'income_>50K'

    if target_column_name not in df_cleaned.columns:
        print("Error: target column ('income_>50K') not found.")
...
if __name__ == '__main__':
    ...
    print("--- Client Started (Adult Income Dataset) ---")
    print(f"Loading data from: {args.data_path}")
    X_local, y_local, actual_input_dim = preprocess_adult_data(args.data_path)
