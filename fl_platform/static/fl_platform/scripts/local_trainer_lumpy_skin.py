...
def preprocess_lumpy_skin_data(df_path):
    try:
    ...
    cols_to_drop = ['reportingDate','region','country']
    ...
    globals()['LUMPY_SKIN_LOGISTIC_REGRESSION'] = X_processed.shape[1]
...
if __name__ == '__main__':
    ...
    X_local, y_local, actual_input_dim = preprocess_lumpy_skin_data(args.data_path)
